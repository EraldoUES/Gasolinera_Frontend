...
def bitacora_user_page(page: ft.Page):
    page.title = "Bitacora"
    page.padding = 10
    ...
    def save_changes():
        try:
            global selected_bitacora, tipo_combustible_global, vehiculo_global, gasolinera_global, proyecto_global
            ...
            if not all([id_tipo_combustible, id_vehiculo, id_gasolinera, id_proyecto]):
            ...
            updated_data = {
                ...
                "id_usr": int(page.session.get("user_id")),
    ...
    def load_roles_to_dropdown():
        global tipo_combustible_global, vehiculo_global, gasolinera_global, proyecto_global
        ...
        try:
            ...
            for bitacora in fetch_bitacora:
                ...
                bitacora_table.rows.append(ft.DataRow(cells=[
                    ...
                    ft.DataCell(ft.IconButton(ft.icons.EDIT, on_click=lambda e, bitacora=bitacora: edit_bitacora(bitacora))) if bitacora["username"]==str(page.session.get("username")) else ft.DataCell(ft.Text("X")),
                ]))
    ...
    def search_by_id(e):
        ...
        try:
            ...
            # Asegurarte de que bitacora es una lista de diccionarios
            for b in bitacora:  # Aquí 'b' será un diccionario
                bitacora_table.rows.append(ft.DataRow(cells=[
                    ...
                    ft.DataCell(ft.Text(b.get("descripcion_tipo_combustible", "N/A"))),  # Usar get en lugar de acceso directo
                    ...
                    ft.DataCell(ft.IconButton(ft.icons.EDIT, on_click=lambda e, bitacora=b: edit_bitacora(bitacora))) if b["username"]==str(page.session.get("username")) else ft.DataCell(ft.Text("X")),
                ]))
    ...
    def save_new_bitacora(e):
        try:
            ...
            if None in [id_tipo_combustible, id_vehiculo, id_gasolinera, id_proyecto]:
    ...
    def show_add_fields(e):
        ...
        add_username_dropdown.value = str(page.session.get("username"))
    ...
    def edit_bitacora(bitacora):
        if bitacora["username"]==str(page.session.get("username")):
            cancel_add()
            load_roles_to_dropdown()
    ...
    add_line3 = ft.Row(visible=False, controls=[add_placa_vehiculo_dropdown, add_nombre_gasolinera_dropdown])
